            ...
            <ul>
                ...
                <img src="images/banner/banner_2.jpg" alt="Sky" class="rev-slidebg"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="tp-caption NotGeneric-Title   tp-resizeme" 
                         ...
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                         data-y="['middle','middle','middle','middle']" data-voffset="['-250','-140','-120','-120']"
                    ...
                    <div class="tp-caption NotGeneric-Title   tp-resizeme" 
                         id="slide-3045-layer-1" 
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                         data-y="['middle','middle','middle','middle']" data-voffset="['-90','0','-10','-40']" 
                        data-fontsize="['170','120','80','40']"
                        data-lineheight="['200','120','70','70']"
                        data-width="none"
                        data-height="none"
                    ...
                    <a href="#" class="nav-link sign-in js-modal-show"><div class="tp-caption rev-btn rev-btn left_btn" 
                        id="slide-2939-layer-8" 
                        data-x="['center','center','center','center']" data-hoffset="['0','280','190','120']" 
                    ...
                    <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                        ...
                        <div class="tab-content card">
                            ...
                            <div class="tab-pane fade" id="panel2" role="tabpanel">
                                <form action="checksignup.php" method="post" class="register">
                                    <div class="row">
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-11">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="dob" placeholder="Date">
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                            <div class="form-group">
...
<section id="scroll-top" class="scroll-top">
   ...
   <!--here deleted the code of the side button-->
</body>
</html>
